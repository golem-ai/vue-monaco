  ...
  ***************************************************************************** */
  ...
  function toVue3ComponentInstance(vm) {
      ...
      instanceProps.forEach(function (prop) {
          proxy$1(instance, prop, {
              get: function () {
                  return vm["$" + prop];
              },
          });
      });
      proxy$1(instance, 'isMounted', {
          get: function () {
              // @ts-expect-error private api
              return vm._isMounted;
          },
      });
      proxy$1(instance, 'isUnmounted', {
          get: function () {
              // @ts-expect-error private api
              return vm._isDestroyed;
          },
      });
      proxy$1(instance, 'isDeactivated', {
          get: function () {
              // @ts-expect-error private api
              return vm._inactive;
          },
      });
      proxy$1(instance, 'emitted', {
          get: function () {
              // @ts-expect-error private api
              return vm._events;
          },
  ...
  function set$1(target, key, val) {
      ...
      function ssrMockReactivity() {
          ...
          if (ob && isObject$1(val) && !hasOwn$1(val, '__ob__')) {
              mockReactivityDeep(val);
          }
      }
      if (isArray(target)) {
          if (isValidArrayIndex$1(key)) {
              target.length = Math.max(target.length, key);
              target.splice(key, 1, val);
              ssrMockReactivity();
              return val;
  ...
  function mockReactivityDeep(obj, seen) {
      ...
      if (seen.has(obj) || hasOwn$1(obj, '__ob__') || !Object.isExtensible(obj))
          return;
      def$1(obj, '__ob__', mockObserver(obj));
      seen.add(obj);
      try {
  ...
  function updateVmAttrs(vm, ctx) {
      ...
      var _loop_1 = function (attr) {
          if (!hasOwn$1(attrBindings.data, attr)) {
              proxy$1(attrBindings.data, attr, {
                  get: function () {
  ...
  function mixin(Vue) {
      ...
      function initSetup(vm, props) {
          ...
          def$1(props, '__ob__', createObserver());
  ...
  function install(Vue) {
      ...
      Vue.config.optionMergeStrategies.setup = function (parent, child) {
          return function mergedSetupFn(props, context) {
              return mergeData$1(isFunction(parent) ? parent(props, context) || {} : undefined, isFunction(child) ? child(props, context) || {} : undefined);
          };
      };
  ...
  var MonacoEditor = defineComponent({
    name: 'MonacoEditor',
    props: {
      original: String,
      value: {
